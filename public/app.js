    ...
    var app = new Vue({
        ...
        methods: {
            onSubmit: function onSubmit() {
                ...
                var calculator = new SterlingCalculator(penniesAmount);
...
var SterlingCalculator = function () {
    ...
    _createClass(SterlingCalculator, [{
        key: "calculateAll",
        value: function calculateAll(amount, rate) {
            if (amount / rate >= 1) {
        ...
        get: function get() {
            ...
            var rates = [200, 100, 50, 20, 10, 5, 2, 1];
            var amount = void 0;
            rates.forEach(function (rate) {
                if (rate === 200) {
                    amount = _this.penniesAmmount;
                }
                _this.calculateAll(amount, rate);
                amount = amount % rate;
            });
        ...
        get: function get() {
            var result = 0;
            for (var rate in this.calculation) {
