...
var PennyParser = __webpack_require__(2);
var SterlingCalculator = __webpack_require__(3);
...
var PennyParser = function () {
    function PennyParser(string) {
        _classCallCheck(this, PennyParser);
        ...
        var areValidCharactersPattern = new RegExp('^[0-9\.\p\£\]*$');
        this.areValidCharacters = areValidCharactersPattern.test(string);
        var areNumbersNotPresentPattern = new RegExp('^([^0-9]*)$');
        this.areNumbersNotPresent = areNumbersNotPresentPattern.test(string);
    }

    _createClass(PennyParser, [{
        key: 'sterlingConvertToNumber',
        value: function sterlingConvertToNumber() {
            var stringNumber = this.string.replace(/p/g, '').replace(/£/, '');
            return Math.floor(parseFloat(stringNumber) * 100);
        }
    }, {
        key: 'pConvertToNumber',
        value: function pConvertToNumber() {
            var stringNumber = this.string.replace(/p/g, '');
            return parseFloat(stringNumber);
        }
    }, {
        key: 'pDotConvertToNumber',
        value: function pDotConvertToNumber() {
            var stringNumber = this.string.replace(/p/g, '');
            return parseFloat(stringNumber) * 100;
        }
    }, {
        key: 'invalidCharacterError',
        value: function invalidCharacterError() {
            return new Error('invalid character');
        }
    }, {
        key: 'missingValuesError',
        value: function missingValuesError() {
...
var SterlingCalculator = function () {
    function SterlingCalculator(number) {
        _classCallCheck(this, SterlingCalculator);
    ...
    _createClass(SterlingCalculator, [{
        key: "calculateTwoPounds",
        value: function calculateTwoPounds() {
            var remainder = this.penniesAmmount % 200;
        ...
        key: "calculateOnePound",
        value: function calculateOnePound(amount) {
        ...
        key: "calculateFiftyP",
        value: function calculateFiftyP(amount) {
        ...
        key: "calculateTwentyP",
        value: function calculateTwentyP(amount) {
        ...
        key: "calculateTenP",
        value: function calculateTenP(amount) {
        ...
        key: "calculateFiveP",
        value: function calculateFiveP(amount) {
        ...
        key: "calculateTwoP",
        value: function calculateTwoP(amount) {
        ...
        key: "calculateOneP",
        value: function calculateOneP(amount) {
            if (amount >= 1) {
